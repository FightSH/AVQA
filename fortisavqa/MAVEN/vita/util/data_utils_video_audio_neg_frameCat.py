...
def preprocess_multimodal(
    ...
    for source in sources:
        ...
        for i, sentence in enumerate(source):
            ...
            sentence["value"] = sentence["value"].replace("\n\n", "\n")
            # print("inserted_id==i", i==inserted_id)
            if i == inserted_id:
...
def preprocess_mixtral_two_mccd(
    sources,
    tokenizer: transformers.PreTrainedTokenizer,
    has_image: bool = False,
    has_audio: bool = False,
    ...
    # Apply prompt templates
    conversations = [conv.get_prompt(modality)]
...
def preprocess(
    ...
    if conversation_lib.default_conversation.version == "mixtral_zh":
        ...
        # print("conversation_lib.default_conversation.version == mixtral_two")
...
def _get_rawvideo_dec(
    ...
    if num_frames > 0:
        ...
        # print("=====================new_patch_images.length", len(new_patch_images))
        ...
        if image_aspect_ratio == "pad":
            ...
            def expand2square(pil_img, background_color):
                ...
                if width == height:
                    ...
                    return result
            print("patch_images_0: ", patch_images)
            patch_images = [
        ...
        # slice_len = len(patch_images) // 5    # old
        slice_len = len(patch_images)   # Jie for new
