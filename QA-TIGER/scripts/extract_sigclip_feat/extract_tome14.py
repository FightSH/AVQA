...
if __name__ == "__main__":
    ...
    parser.add_argument("--dir_path", type=str, default='/mnt/sda/shenhao/datasets/MUSIC-AVQA/frames/',
                        help='sec path')
    parser.add_argument("--dst_path", type=str, default='/mnt/sda/shenhao/datasets/siglip/MUSIC-AVQA/siglip_patch_tome14/',
                        help='sec save path')
    ...
    parser.add_argument("--model_name", type=str, default="vit_so400m_patch14_siglip_384", help='model_name')
